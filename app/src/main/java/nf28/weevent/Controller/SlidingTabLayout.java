    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
           ...
           // tabTitleView.setText(adapter.getPageTitle(i));
            ...
            // init the proper tab index from drawable
            Drawable img = null;
            switch(ViewPagerAdapter.getTabName(i)){
                case 0:
                    img = getContext().getResources().getDrawable(R.drawable.ic_desc);
                    break;
                case 1:
                    img = getContext().getResources().getDrawable(R.drawable.ic_evt);
                    break;
                case 2:
                    img = getContext().getResources().getDrawable(R.drawable.ic_date);
                    break;
                case 3:
